...
class Producer:
    ...
    def __init__(
        ...
        self.broker_properties = {
            # TODO
            'URL_BROKER':'PLAINTEXT://localhost:9092',
            'URL_SCHEMA_REGISTRY':'http://localhost:8081'
        }
        ...
        # TODO: Configure the AvroProduce
        
        self.producer = AvroProducer(
                {
                    'bootstrap.servers': self.broker_properties["URL_BROKER"]
                },
                schema_registry = CachedSchemaRegistryClient(
                        {"url": self.broker_properties['URL_SCHEMA_REGISTRY']}),
